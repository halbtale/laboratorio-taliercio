...
public class NumTypeTester {
        public static void main(String[] args) {
                ...
                int verylargeint = 2100000000; // se verylargeint ha un valore vicino a
                                               ...
                                               // risultato inaspettato. Perche`?. -> overflow -> codifica complemento a
                                               // due
                ...
                // int smallint = smalldouble; //cosi` non funziona (provare). Perche`? int ha
                // meno precisione di double quindi genera errore
                ...
                int largeint = (int) largedouble; // se largedouble e` piu` grande di
                                                  ...
                                                  // Perche`?. -> si ferma al valore massimo
                ...
                // succede che result vale 0 invece che 1. Come e` possibile?? -> si perde
                // precisione
                ...
                // Provare con veryverylargedouble1 = 1e308. Cosa succede e perche'? -> dopra
                // massimo valore
